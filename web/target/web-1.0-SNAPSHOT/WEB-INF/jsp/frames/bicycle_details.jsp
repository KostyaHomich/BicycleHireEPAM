...
<div class="container">
    <section id="content">
        ...
        <form action="${pageContext.request.contextPath}/bicycles" method="post">
            ...
            <div>
                <input type="text"
                        <c:if test="${not empty sessionScope.signInUser && sessionScope.signInUser.getRoles().contains(UserRole.ROLE_USER)}">
                            readonly
                        </c:if>
            ...
            <c:if test="${not empty sessionScope.signInUser && sessionScope.signInUser.getRoles().contains(UserRole.ROLE_ADMIN)}">
                <div>
            ...
            && sessionScope.signInUser.getRoles().contains(UserRole.ROLE_ADMIN)}">
                    ...
                    <c:if test="${requestScope.bicycle.getId()!=0}">
                        <input type="hidden" name="command" value="${UPDATE_BICYCLE}">
